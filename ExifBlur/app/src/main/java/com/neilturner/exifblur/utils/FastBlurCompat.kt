package com.neilturner.exifblur.utils
...
internal object FastBlurCompat {
     ...
     * 
     * @return A new mutable bitmap with the blur applied (original is unchanged if it was immutable)
     */
    fun applyBlur(
        bitmap: Bitmap,
        radius: Int,
        ...
        // Always create a mutable copy to avoid issues with HARDWARE or immutable bitmaps
